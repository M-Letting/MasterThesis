...
pert_levels <- c(
  "1 Peptide",
  "2 Peptides",
  "Random (1 to %50) Peptides",
  "%50 Peptides"
)
pert_labels <- c("One", "Two", "Random", "50%")
...
ggsave(
  "00-ThesisFigures/Figures/FindDCF/FindDCF_Performance.pdf",
  combined,
  width = 10,
  height = 6
)
ggsave(
  "00-ThesisFigures/Figures/FindDCF/FindDCF_Performance.png",
  combined,
  width = 10,
  height = 6,
  dpi = 300
...
cat("Saved: 00-ThesisFigures/Figures/FindDCF/FindDCF_Performance.pdf/.png\n")
...
scatter_panels <- mapply(
  make_scatter_panel,
  lvl = pert_labels,
  title = c("One Peptide", "Two Peptides", "Random Peptides", "50% Peptides"),
  SIMPLIFY = FALSE
)
...
ggsave(
  "00-ThesisFigures/Figures/FindDCF/FindDCF_Scatter.pdf",
  p_scatter_fig,
  width = 10,
  height = 6
)
ggsave(
  "00-ThesisFigures/Figures/FindDCF/FindDCF_Scatter.png",
  p_scatter_fig,
  width = 10,
  height = 6,
  dpi = 300
...
cat("Saved: 00-ThesisFigures/Figures/FindDCF/FindDCF_Scatter.pdf/.png\n")

# ── Extended figure: scatter (1×4) + combined F1 bar ─────────────────────────

f1_at_001 <- scatter_highlights[thr_label == "p = 0.01"]

scatter_grid_1row <- plot_grid(
  plotlist = scatter_panels,
  nrow = 1,
  labels = c("A", "B", "C", "D"),
  label_size = 13
...
ggsave(
  "00-ThesisFigures/Figures/FindDCF/FindDCF_Scatter_Extended.pdf",
  p_scatter_extended,
  width = 14,
  height = 6
)
ggsave(
  "00-ThesisFigures/Figures/FindDCF/FindDCF_Scatter_Extended.png",
  p_scatter_extended,
  width = 14,
  height = 6,
  dpi = 300
...
cat(
  "Saved: 00-ThesisFigures/Figures/FindDCF/FindDCF_Scatter_Extended.pdf/.png\n"
)
